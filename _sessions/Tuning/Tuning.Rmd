...
<ul>
  <li class="m1"><span>Specify the use of k-fold cross-validation using the `trainControl()` function.</span></li>
</ul>
...
<h1><a href=https://therbootcamp.github.io/AML_2020AMLD/_sessions/Optimization/Optimization_practical.html>Practical</a></h1>
